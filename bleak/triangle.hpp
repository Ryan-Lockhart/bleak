...
namespace bleak {
	struct triangle_2d_t {
		...
		offset_2d_t vertices[3]{ offset_2d_t{ 0 }, offset_2d_t{ 0 }, offset_2d_t{ 0 } };
		...
		constexpr offset_2d_t::product_t perimeter() const noexcept {
			return offset_2d_t::distance<offset_2d_t::product_t>(vertices[0], vertices[1]) + offset_2d_t::distance<offset_2d_t::product_t>(vertices[1], vertices[2]) + offset_2d_t::distance<offset_2d_t::product_t>(vertices[2], vertices[0]);
		}
		...
		constexpr line_2d_t a() const noexcept { return line_2d_t{ vertices[0], vertices[1] }; }

		constexpr line_2d_t b() const noexcept { return line_2d_t{ vertices[1], vertices[2] }; }

		constexpr line_2d_t c() const noexcept { return line_2d_t{ vertices[2], vertices[0] }; }
