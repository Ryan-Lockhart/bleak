...
namespace bleak {
	struct area_t : public std::unordered_set<offset_t, offset_t::hasher> {
		...
		template<typename T, extent_t Size, extent_t BorderSize> inline area_t(cref<zone_t<T, Size, BorderSize>> zone, cref<offset_t> position, cref<T> value, offset_t::product_t distance) {
		...
		template<typename T, extent_t Size, extent_t BorderSize> inline void recalculate(cref<zone_t<T, Size, BorderSize>> zone, cref<T> value) {
			clear();
		...
		template<typename T, extent_t Size, extent_t BorderSize> inline void recalculate(cref<zone_t<T, Size, BorderSize>> zone, cref<offset_t> position, cref<T> value) {
			clear();
		...
		template<typename T, typename U, extent_t Size, extent_t BorderSize>
			requires is_equatable<T, U>::value
		inline void recalculate(cref<zone_t<T, Size, BorderSize>> zone, cref<offset_t> position, cref<U> value) {
			clear();
		...
		inline void recalculate(cref<zone_t<T, Size, BorderSize>> zone, cref<offset_t> position, cref<T> value, cref<D> distance) {
			clear();
		...
		inline void recalculate(cref<zone_t<T, Size, BorderSize>> zone, cref<offset_t> position, cref<U> value, cref<D> distance) {
			clear();
		...
		template<typename T, extent_t Size, extent_t BorderSize> inline void apply(ref<zone_t<T, Size, BorderSize>> zone, cref<T> value) const noexcept {
			for (cref<offset_t> position : *this) {
				zone[position] += value;
			}
		}

		template<typename T, extent_t Size, extent_t BorderSize> inline void repeal(ref<zone_t<T, Size, BorderSize>> zone, cref<T> value) const noexcept {
			for (cref<offset_t> position : *this) {
				zone[position] -= value;
			}
		}
